  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.parrafo}>
        ¡Hola!👋 Soy Ivan Plaza, un apasionado desarrollador Full Stack con un fuerte enfoque en el mundo del Backend. Siempre estoy buscando adquirir nuevos conocimientos para innovar y crear soluciones increíbles para proyectos. Me encanta trabajar en equipo y disfruto colaborar con personas creativas.🚀💥<br />
        Especializado en Front-end y Back-end, cuento con amplia experiencia en diversas tecnologías y frameworks. Además, tengo conocimientos en testing QA manual y Python, lo que me permite asegurar la calidad y robustez de las aplicaciones que desarrollo. Siempre estoy dispuesto a enfrentar nuevos desafíos y aprender de ellos. Mi objetivo es aportar de manera positiva en cada proyecto, buscando soluciones innovadoras que mejoren la experiencia del usuario. <br />
